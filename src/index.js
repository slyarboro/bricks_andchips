...
var HELP_MESSAGE = "You can say tell me something good, or, you can say exit... What's it going to be?";
...
var data = [
    ...
    "Big's entrepreneurship and crack ventures ultimately resulted in a ten year suspended sentence with nine months jail time and subsequent probation.",
    "Wallace first used the moniker, 'Biggie Smalls', on the demo he made following his release from a North Carolina jail.",
    "It is the demo Biggie made following his jail sentence in the Carolinas that ultimately led to his recording contract with Uptown Records.",
    ...
    "The 'Ten Crack Commandments' are step-by-step instructions Wallace curated in effort to maximize successes of tradesmen while fending off ill-adjusted hair pieces.",
